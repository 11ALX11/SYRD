...
// Каждая библиотека возвращает некоторый объект через module.exports. Функция require динамически находит
...
class Application {
    ...
    attachRoutes () {
        ...
        // Папка для расположения файлов, стилей, скриптов и др.
        ...
        // Обработка несуществующего пути (ToDo error page)
